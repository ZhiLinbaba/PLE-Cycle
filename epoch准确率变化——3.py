...
# start_index = 0  # Modify as per your requirement
# end_index = 499  # Modify as per your requirement
#
# for model_index in range(start_index, end_index + 1, 1):
#     # Load the saved model parameters
#     model_path = f'D:/Code/python/多属性反演/lstm_pt/SEAM/多属性/PLE{model_index}'
...
#
#     print(f"{model_index}   {p_vs:.3f}     {s_vs:.3f}    {m_vs:.4f}     {p_vp:.3f}     {s_vp:.3f}    {m_vp:.4f}     {p_imp:.3f}     {s_imp:.3f}    {m_imp:.4f}")
